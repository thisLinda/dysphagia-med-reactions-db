package com.forlizzi.medication.errorhandling;
...
public class GlobalErrorHandler {
    ...
    public Map<String, Object> handleIllegalArgumentException(MethodArgumentTypeMismatchException e, WebRequest webRequest) {
